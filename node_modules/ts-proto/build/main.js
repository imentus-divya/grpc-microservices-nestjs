...
function generateOneofProperty(ctx, messageDesc, oneofIndex, sourceInfo) {
    ...
    const unionType = (0, ts_poet_1.joinCode)(fields.map((f) => {
        ...
        return (0, ts_poet_1.code) `{ ${mbReadonly}$case: '${fieldName}', ${mbReadonly}${valueName}: ${typeName} }`;
    }), { on: " | " });
    ...
    `;
        ...
        if ((0, types_1.isRepeated)(field)) {
            ...
            if (${messageProperty} === undefined ${(0, utils_1.withOrMaybeCheckIsNull)(options, messageProperty)}) {
              ${messageProperty} = ${generateMapType ? "new Map()" : "{}"};
                    ...
                    : "";
                const ifValueCheck = `${varName}.value !== undefined ${(0, utils_1.withAndMaybeCheckIsNotNull)(options, `${varName}.value`)}`;
                const maybeIfKeyCheck = `${options.noDefaultsForOptionals
                    ? ` && ${varName}.key !== undefined ${(0, utils_1.withAndMaybeCheckIsNotNull)(options, `${varName}.key`)}`
                    : ""}`;
                chunks.push((0, ts_poet_1.code) `
          ${tagCheck}
        ...
        `);
          ...
          `);
            ...
            const valueName = (0, utils_1.oneofValueName)(fieldName, options);
            chunks.push((0, ts_poet_1.code) `
        ${tagCheck}
          ...
          `);
            ...
            if (!processedOneofs.has(field.oneofIndex)) {
                ...
                for (const oneOfField of oneOfFieldsDict[field.oneofIndex]) {
                    ...
                    const valueName = (0, utils_1.oneofValueName)(oneOfFieldName, ctx.options);
...
function generateExtension(ctx, message, extension) {
    ...
    `);
        ...
        `);
            ...
            chunks.push((0, ts_poet_1.code) `
        if (${(0, types_1.notDefaultCheck)(ctx, extension, message?.options, "value")}) {
          const writer = ${Writer}.create();
          ${writeSnippet("value")};
          encoded.push(writer.finish());
        }
    ...
    messageDesc.field.forEach((field) => {
        ...
        const readSnippet = (from) => {
            if ((0, types_1.isEnum)(field)) {
                ...
                if ((0, types_1.isBytes)(field)) {
                    ...
                    const fieldType = (0, types_1.getFieldOptionsJsType)(field, ctx.options) ?? field.type;
        ...
        if (canonicalFromJson[fullTypeName]?.[fieldName]) {
          ...
          `);
            ...
            const valueName = (0, utils_1.oneofValueName)(fieldKey, options);
